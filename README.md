...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-black-1772976145) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-black-1772976145.git
$ cd django-black-1772976145
```
